...
class Predictor(object):
    ...
    def data_load(self, model_base_path='./embedding/', entity_relation_base_path = './benchmarks/FKB/', o_m_base_path = './benchmarks/OMKG/'):
    ...
    def predict(self, target_performance):
        path_detail = []
        with open('./benchmarks/FKB/pathList.txt') as f:
            f.readline()
            i = 0
